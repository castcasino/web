        ...
        <div class="w-full relative bg-white">
            <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-12">
                ...
                <nav class="hidden space-x-10 md:flex">
                    <!-- <NuxtLink to="/players" class="text-base font-medium text-gray-500 hover:text-gray-900">
                        Players
                    </NuxtLink> -->

                    <!-- <NuxtLink to="/bankers" class="text-base font-medium text-gray-500 hover:text-gray-900">
                        Bankers
                    </NuxtLink> -->
                ...
                <div class="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                    ...
                    <div class="py-6 px-5">
                        <div class="grid grid-cols-2 gap-4">
                            <NuxtLink to="/players" class="text-base font-medium text-gray-900 hover:text-gray-700">
                                Players
                            </NuxtLink>

                            <NuxtLink to="/bankers" class="text-base font-medium text-gray-900 hover:text-gray-700">
                                Bankers
                            </NuxtLink>

                            <NuxtLink to="/fairplay" class="text-base font-medium text-gray-900 hover:text-gray-700">
                                Fairplay
                            </NuxtLink>
                        </div>
